...
function checkUsernameAndPassword() {
     ...
     if(un==""){
          ...
          $("#usernameIcon a svg use").attr("xlink:href", "/static/cie_wrong_credentials_it/sprite.svg#it-warning");
          return false;
     }else if( 
          ! ( 
          ...
          $("#usernameIcon a svg use").attr("xlink:href", "/static/cie_wrong_credentials_it/sprite.svg#it-info-circle");
