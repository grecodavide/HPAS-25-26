...
function checkUsernameAndPassword() {
     ...
     if(un==""){
          ...
          $("#usernameIcon a svg use").attr("xlink:href", "{{url_for('static', filename='login_cie/sprite.svg')}}#it-warning");
          return false;
     }else if( 
          ! ( 
          ...
          $("#usernameIcon a svg use").attr("xlink:href", "{{url_for('static', filename='login_cie/sprite.svg')}}#it-info-circle");
